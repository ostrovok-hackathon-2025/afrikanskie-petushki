...
const getApplicationId = <TData = AxiosResponse<DocsApplicationResponse>>(
    ...
    return axios.get(
      `http://localhost:8081/api/v1/application/${id}`,options
    );
  }
...
const getHotel = <TData = AxiosResponse<DocsGetHotelsResponse>>(
    ...
    return axios.get(
      `http://localhost:8081/api/v1/hotel/`,options
    );
  }
...
const postHotel = <TData = AxiosResponse<DocsCreateHotelResponse>>(
    ...
    return axios.post(
      `http://localhost:8081/api/v1/hotel/`,
...
const getLocation = <TData = AxiosResponse<DocsGetLocationsResponse>>(
    ...
    return axios.get(
      `http://localhost:8081/api/v1/location/`,options
    );
  }
...
const getOffer = <TData = AxiosResponse<DocsGetOffersResponse>>(
    ...
    return axios.get(
      `http://localhost:8081/api/v1/offer/`,{
    ...options,
        params: {...params, ...options?.params},}
    );
  }
...
const getOfferSearch = <TData = AxiosResponse<DocsGetOffersResponse>>(
    ...
    return axios.get(
      `http://localhost:8081/api/v1/offer/search`,{
    ...options,
        params: {...params, ...options?.params},}
    );
  }
...
const getOfferId = <TData = AxiosResponse<DocsOfferResponse>>(
    ...
    return axios.get(
      `http://localhost:8081/api/v1/offer/${id}`,options
    );
  }
...
const patchOfferId = <TData = AxiosResponse<void>>(
    ...
    return axios.patch(
      `http://localhost:8081/api/v1/offer/${id}`,
...
const getReportMy = <TData = AxiosResponse<DocsGetReportsResponse>>(
    ...
    return axios.get(
      `http://localhost:8081/api/v1/report/my`,{
    ...options,
        params: {...params, ...options?.params},}
    );
  }
...
const getReportMyId = <TData = AxiosResponse<DocsReportResponse>>(
    ...
    return axios.get(
      `http://localhost:8081/api/v1/report/my/${id}`,options
    );
  }
...
const getReportId = <TData = AxiosResponse<DocsReportResponse>>(
    ...
    return axios.get(
      `http://localhost:8081/api/v1/report/${id}`,options
    );
  }
...
const patchReportIdConfirm = <TData = AxiosResponse<void>>(
    ...
    return axios.patch(
      `http://localhost:8081/api/v1/report/${id}/confirm`,
...
const getRoom = <TData = AxiosResponse<DocsGetRoomsResponse>>(
    ...
    return axios.get(
      `http://localhost:8081/api/v1/room/`,options
    );
  }
...
const getUser = <TData = AxiosResponse<DocsUserResponse>>(
    ...
    return axios.get(
      `http://localhost:8081/api/v1/user/`,options
    );
  }
...
const postUserLogIn = <TData = AxiosResponse<DocsAuthResponse>>(
    ...
    return axios.post(
      `http://localhost:8081/api/v1/user/log-in`,
...
const postUserRefresh = <TData = AxiosResponse<DocsAuthResponse>>(
    ...
    return axios.post(
      `http://localhost:8081/api/v1/user/refresh`,
...
const postUserSignUp = <TData = AxiosResponse<DocsAuthResponse>>(
    ...
    return axios.post(
      `http://localhost:8081/api/v1/user/sign-up`,
